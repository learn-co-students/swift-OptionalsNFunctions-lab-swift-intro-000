...
var items = [5,4,3,10,1,38,100]

print(minimum(list: items))
...
print("The minimum is: \(minimum(list: values1))")
 ...
 */
let values2: [Int] = []
// print("The minimum is: \(minimum(list: values2))")
