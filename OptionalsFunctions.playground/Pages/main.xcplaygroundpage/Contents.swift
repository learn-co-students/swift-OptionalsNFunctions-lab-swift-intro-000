...
// petName is of type 'String' and it's value is "Scooter the Turtle 🐢"
...
// otherPetName is of type 'Optional' and its value is 'nil' (no value)

/*: question3
 ### 3. What is the _current value_ of `otherPetName`?
 */
// value of 'nil' - optionals default to value of nil
...
// of type 'Optional' or 'String?' and value declared 'nil'
...
// you can assign any value of type 'String' to thirdPetName. Even when it has a value, its type is still `String?`, because the variable's type does not change just because you assigned a value to it.
...
// expected to see an 'Optional' before the assigned value of "Mittens 🐈"
