...
// pet name is String and value is "Scooter the Turtle 🐢"
...
// it is an optional String and the value is nil
...
thirdPetName = "Ernie"
//thirdPetName is assigned a String value. It is on optional String type.
...
if let animalName = thirdPetName {
    print("\(animalName)")
}
