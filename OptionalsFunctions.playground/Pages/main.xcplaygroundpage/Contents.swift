...
// This is a String of "Scooter the Turtle 🐢"
/*: question2
 ### 2. What is the type of the variable `otherPetName` declared below? What is its value?
 */
var otherPetName: String?

//This is an Optional of "nil" value
/*: question3
...
//It is an Optional of "nil" value
/*: question5
...
//I expect to see "Optional("Thomas")"
...
func minimum(list: [Int]) -> Int {
    var minimumNum: Int = list[0]
    for currNum in list{
        if minimumNum > currNum{
            minimumNum = currNum
        }
    }
    return minimumNum
...
//The return value should be nil
