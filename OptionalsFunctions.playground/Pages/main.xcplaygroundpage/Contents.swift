...
print("String? and the current value is nil")
...
print("You can assign Strings. After assigning a value its value is still String?")
...
print("expect to see Optional('Nemo')")
